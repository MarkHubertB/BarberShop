...
class BookingConfirmed extends Notification
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        return (new MailMessage)
            ->subject('Your Booking is Confirmed - ' . $this->booking->reference_code)
            ->greeting('Your cut is locked in.')
            ...
            ->action('View Booking', route('booking.confirmation', $this->booking->reference_code));
    }
}
